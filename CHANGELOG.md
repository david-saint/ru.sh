...
### Fixed
- Reject unclosed code fences as malformed in API response parsing.
- Resolved CI failures (clippy `collapsible_if` and rustfmt).

### Changed
- Hardened API response parsing with `Cow` semantics and improved test coverage.
